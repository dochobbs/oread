...
# Open your browser to http://localhost:9104
```
...
curl http://localhost:9104/api/patients/abc123

# Export as FHIR
curl http://localhost:9104/api/patients/abc123/export/fhir -o patient.fhir.json

# Export as C-CDA
curl http://localhost:9104/api/patients/abc123/export/ccda -o patient.ccda.xml
```
...
- Explore the API docs at http://localhost:9104/docs
